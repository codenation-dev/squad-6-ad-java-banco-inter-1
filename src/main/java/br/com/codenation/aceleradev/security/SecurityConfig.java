...
import br.com.codenation.aceleradev.dto.UserDTO;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void authenticationManager(AuthenticationManagerBuilder builder, UsuarioRepository userRepository) throws Exception {
        builder.userDetailsService(email -> new UserDTO(userRepository.findByEmail(email))).passwordEncoder(passwordEncoder());
    }
